...
public class JacksonJSONConfigTest {
    ...
    void load() throws ConfigException {
        ...
        config.load(SOURCE_1, JacksonConfigSerializer.DEFAULT_JSON);
    ...
    void save() throws ConfigException {
        ...
        config.save(SOURCE_1, JacksonConfigSerializer.DEFAULT_JSON);
    }
    ...
    void holderLoad() throws ConfigException {
        ...
        holder.load(SOURCE_2, JacksonConfigSerializer.DEFAULT_JSON);
        System.out.println(holder.isPresent());
    ...
    void holderSave() throws ConfigException {
        ...
        System.out.println(holder.isPresent());
        holder.save(SOURCE_2, JacksonConfigSerializer.DEFAULT_JSON);
    }
}
