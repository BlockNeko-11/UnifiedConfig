...
import io.github.blockneko11.config.unified.impl.Toml4JConfigSerializer;
import io.github.blockneko11.config.unified.impl.source.SimpleConfigSource;
import org.junit.jupiter.api.Test;

public class Toml4JConfigTest {
    ...
    void load() throws ConfigException {
        ...
        config.load(SOURCE_1, Toml4JConfigSerializer.DEFAULT);
    ...
    void save() throws ConfigException {
        ...
        config.save(SOURCE_1, Toml4JConfigSerializer.DEFAULT);
    }

    private static final IConfigSource SOURCE_2 = new SimpleConfigSource(() -> "score = 100\n" +
            "timestamp = 100000000\n" +
            "temperature = 36.5\n" +
            ...
            "name = \"George\"\n" +
            "gender = \"MALE\"\n" +
            "address = \"Beijing, China\"", System.out::println);
    ...
    void holderLoad() throws ConfigException {
        ...
        holder.load(SOURCE_2, Toml4JConfigSerializer.DEFAULT);
        System.out.println(holder.isPresent());
    ...
    void holderSave() throws ConfigException {
        ...
        System.out.println(holder.isPresent());
        holder.save(SOURCE_2, Toml4JConfigSerializer.DEFAULT);
    }
}
